...
async function __uvHook(window, config = {}, bare = '/bare/') {
    ...
    client.element.hookProperty([HTMLScriptElement, HTMLAudioElement, HTMLVideoElement,  HTMLMediaElement, HTMLImageElement, HTMLInputElement, HTMLEmbedElement, HTMLIFrameElement, HTMLTrackElement], 'src', {
        get: (target, that) => {
            return __uv.sourceUrl(
                target.call(that)
            );
